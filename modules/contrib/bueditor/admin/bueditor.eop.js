...
$(document).ready(function() {
  $('a.eop-copy, a.eop-add-default').click(function() {
    var name = prompt(Backdrop.t('Editor name'), this.name);
  ...
  $('a.eop-delete').click(function() {
    ...
    var msg = Backdrop.t('Are you sure you want to delete the editor @name?', {'@name': lnk.name.substr(8)}) +'\n';
    msg += Backdrop.t('All buttons and settings of this editor will be removed.') +'\n';
    msg += Backdrop.t('This action cannot be undone.');
    if (confirm(msg)) {
