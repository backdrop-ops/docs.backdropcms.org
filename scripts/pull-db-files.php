...
$db_url = 'https://sanitize.backdropcms.org/docs.backdropcms.org/sanitized/docs_backdrop-latest-sanitized.sql.gz';
$files_url = 'https://sanitize.backdropcms.org/docs.backdropcms.org/files_backups/docs_backdrop-files-latest.tar.gz';
